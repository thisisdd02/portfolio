        ...
        <div className={styles.box}>
          ...
          <div className={styles.right_section_indexing}>
            ...
            <div className={styles.symbol}>
              ...
              <p>East main St, Thanjavur ,Tamilnadu</p>
            </div>
            ...
            <div className={styles.follow_me_section}>
              ...
              <div className={styles.account_box}>
                ...
                <div className={styles.account_icon}>
                  <a
                    href="https://www.linkedin.com/in/divyadharshini-balakrishnan-493892307/"
                    target="_blank"
                ...
                <div className={styles.account_icon}>
                  <a
                    href="https://github.com/thisisdd02"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                ...
                <div className={styles.account_icon}>
                  <a
                    href="https://www.instagram.com/divzzz_dd/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
